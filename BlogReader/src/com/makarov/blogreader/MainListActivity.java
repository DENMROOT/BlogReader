...
public class MainListActivity extends ListActivity {
	...
	//protected String [] mBlogPostTitles; - устаревшее 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* инициализация строк из хранилища strings (строка или массив строк)
	...
	public void handleBlogResponce() {
		...
		if (mBlogData == null) {
			...
			try {
				...
				//mBlogPostTitles = new String [jsonPosts.length()]; устаревшее 
